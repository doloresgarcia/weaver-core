...
from weaver.nn.model.layers.graph import (
    create_graph_knn,
    create_graph_knn2,
    create_graph_knn_diffs,
)
...
"""
from weaver.nn.model.layers.graph_transformer_edge_layer import GraphTransformerLayer
from weaver.nn.model.layers.mlp_readout_layer import MLPReadout
...
class GraphTransformerNet(nn.Module):
    def __init__(self, dev):
        ...
        self.embedding_e = nn.Linear(4, hidden_dim)  # node feat is an integer
